 ...
 <body>
   <div class="container">
     <img src="<?= base_url() ?>assets/img/uaspos.png" height="150" style="padding-top: 15px" class="rounded mx-auto d-block mb-10" />
     <h3 class="text-center"><strong>E-POSYANDU</strong></h3>
   </div>
   <div class="container">
       ...
       <div class="col-md-5">
         <div class="card">
           <div class="card-header card-header-primary">
             <h4 class="card-title text-center">LOGIN KADER</h4>
             <?= $this->session->tempdata('err'); ?>
             <?= $this->session->tempdata('message'); ?>
             <p class="card-category"></p>
           </div>
           <div class="card-body">
             <form action="<?= base_url() ?>auth/postLogin2" method="POST">
               <div class="form-group">
                 <label class="bmd-label-floating" name="nama" style="color:black;">Kode Posyandu</label>
